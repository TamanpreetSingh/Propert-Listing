...
public class SocietyList extends Activity{
	String masters="8888";
int master;
...
private ListView listView;
	...
	ArrayList l1=(ArrayList)db.getSocities();
	...
	while(d.hasNext())
	{
		...
		AddSociety object=(AddSociety)d.next();
		line1="Contact Person: "+object.sName+"\nAddress: "
	            +object.sAddress+"\nSociety Name"+object.sSociety;
		line2="\nCity: "+object.sCity+
...
if(city.equals("Chandigarh")){
				...
				{
					new AlertDialog.Builder(SocietyList.this)
	...
	public void message() {
		try {
			...
			Toast.makeText(SocietyList.this, "Your sms has successfully sent to " + master, 1000).show();
		} catch (Exception ex) {
			ex.printStackTrace();
		}
