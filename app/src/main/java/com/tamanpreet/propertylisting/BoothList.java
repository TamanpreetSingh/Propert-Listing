...
public class BoothList extends Activity{
	String masters="8889";
int master;
...
private ListView listView;
	...
	ArrayList l1=(ArrayList)db.getBooths();
	...
	while(d.hasNext())
	{
		...
		AddBooth object=(AddBooth)d.next();
...
if(city.equals("Chandigarh")){
				...
				if(str.equals("Call"))
				{
					...
					new AlertDialog.Builder(BoothList.this)
	...
	public void message()
	{
		try {
			...
			Toast.makeText(BoothList.this, "Your sms has successfully sent to "+master,1000).show();
		} catch (Exception ex) {
			ex.printStackTrace();
		}
