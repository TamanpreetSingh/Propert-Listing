...
public class SearchHb extends Activity  implements OnItemSelectedListener  {

	Spinner spinnerType,spinnerLocality;
	Button submit;
	EditText address;
	DatabaseHandler db=new DatabaseHandler(SearchHb.this);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.searchhb);
		submit=(Button)findViewById(R.id.submitHsearch);
		address=(EditText)findViewById(R.id.addressHsearch);
		...
		seekbarMax=(SeekBar)findViewById(R.id.seekBarH2);
		seekbarMin=(SeekBar)findViewById(R.id.seekBarH1);
		...
		spinnerLocality=(Spinner)findViewById(R.id.spinnerLocalityHsearch);
...
submit.setOnClickListener(new View.OnClickListener() {
	...
	private void displayAllCity(){
		...
		Cursor cursorAddress=db.getHbCityAll(sMax, sMin);
		String[] columns = new String[] {
			...
			getApplicationContext(), R.layout.list_datahb, 
			cursorAddress, 
			columns, 
			to,
			0);
			
			ListView listView1 = (ListView) findViewById(R.id.searchListHsearch);
			...
			listView1.setOnItemLongClickListener(new OnItemLongClickListener() {
				...
				public boolean onItemLongClick(AdapterView<?> parent, View view,
					...
					AlertDialog.Builder builder1 = new AlertDialog.Builder(SearchHb.this);
		            builder1.setMessage("Please select your option.");
		            builder1.setCancelable(true);
		            builder1.setPositiveButton("Modify",
		                    new DialogInterface.OnClickListener() {
		                public void onClick(DialogInterface dialog, int id) {
		                	 Intent i = new Intent(getApplicationContext(), UpdateHb.class);
	...
	private void displayAllSector(){
		...
		Cursor cursorAddress=db.getHbSectorAll(sCity, sMax, sMin);
		String[] columns = new String[] {
				db.KEY_NAME,
				db.KEY_NUMBER,
				db.KEY_PRICE,
	...
	private void displayAddress(){
		 Log.d("",sAddress);
			Cursor cursorAddress=db.getHbAddress(sAddress);
			String[] columns = new String[] {
					db.KEY_NAME,
					db.KEY_NUMBER,
					db.KEY_PRICE,
	...
	private void displaySectorCity(){
		...
		Cursor cursorAddress=db.getHbCitySector(sCity, sSector, sMax, sMin);
		String[] columns = new String[] {
				db.KEY_NAME,
				db.KEY_NUMBER,
				db.KEY_PRICE,
	...
	private void displayListView() {
		...
		this, R.layout.list_datahb, 
		cursor, 
		columns, 
		to,
		0);
		
		ListView listView = (ListView) findViewById(R.id.searchListHsearch);
		// Assign adapter to ListView
	...
	public void onItemSelected(AdapterView<?> parent, View view, int position, long id){
		...
		if (m_intSpinnerInitiCount < NO_OF_EVENTS || sCity.equals("All")) {
	    	...
	    	AlertDialog.Builder builder = new AlertDialog.Builder(SearchHb.this);
