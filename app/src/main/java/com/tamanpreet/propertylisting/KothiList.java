...
public class KothiList extends Activity{
	String masters="8889";
int master;
...
private ListView listView;
	...
	ArrayList l1=(ArrayList)db.getkothis();
	...
	while(d.hasNext())
	{
		...
		AddKothi object=(AddKothi)d.next();
		line1="Contact Person: "+object.sName+"\nAddress: "
	            +object.sAddress+"\nStorey:"+object.sStorey;
		line2="\nCity: "+object.sCity+
		"\nCondition: "+object.sCondition+"\nBasement: "+object.sBasement+
		"\nSector: "+object.sSector+"\nFloor For Sale:"+object.sForSale+
		"\nAsking Price: "
	+object.sPrice+"\nContact Number: "
				+object.sNumber+"\n";
   ...
   // for (int i = 0; i < l1.size(); i++) {
	...
	listView.setOnItemClickListener(new OnItemClickListener(){
		...
		pop.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
			...
			public boolean onMenuItemClick(MenuItem item) {
				...
				if(str.equals("Call"))
				{
					new AlertDialog.Builder(KothiList.this)
	...
	public void message()
	{
		try {
			...
			Toast.makeText(KothiList.this, "Your sms has successfully sent to "+master,1000).show();
		} catch (Exception ex) {
			ex.printStackTrace();
		}
