...
public class UpdateSco  extends Activity implements OnItemSelectedListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
	    ...
	    submit.setOnClickListener(new View.OnClickListener() {
			...
			Log.d("",sName+sAddress+sCity+sSector+sNumber+sPrice+sCondition+sStorey+sBasement+sForSale+adres);
			   db.UpdateSco(sName, sAddress, sCity, sSector, sNumber, sPrice, sCondition, sStorey, sBasement, sForSale, adres);
			   Intent i=new Intent(getApplicationContext(),SearchSco.class);
				startActivity(i);
				finish();
			}
		});
	...
	private void setText(String adres) {
		// TODO Auto-generated method stub
		Cursor c=db.getScoAddressFull(adres);
