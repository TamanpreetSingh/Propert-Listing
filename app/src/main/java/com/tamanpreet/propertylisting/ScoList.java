...
public class ScoList extends Activity{
	String masters="8889";
int master;
...
private ListView listView;
	...
	ArrayList l1=(ArrayList)db.getSco();
...
if(city.equals("Chandigarh")){
				...
				if(str.equals("Call"))
				{
					new AlertDialog.Builder(ScoList.this)
	...
	public void message()
	{
		try {
			...
			Toast.makeText(ScoList.this, "Your sms has successfully sent to "+master,1000).show();
		} catch (Exception ex) {
			ex.printStackTrace();
		}
